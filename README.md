...
但是我的插件就是上不了AstrBot插件市场😂 

每次AI审核给的要求我都改了，改完再提交又给我找出新的问题...  
（就像打地鼠，一个bug下去，另一个又冒出来）

**不过说真的，我觉得现实投入使用应该没啥大问题了**  
核心功能都正常，安全方面也加固了不少

今天搞了好几个小时，感觉**一个人的力量真的不够**...  
所以，**如果你有能力、有兴趣，欢迎来帮我改进这个插件！**
不管是像我一样的菜鸟“开发者”（我觉得我可能连开发者都算不上吧），还是大佬，都欢迎加入

### ⚠️ 重要提醒！
今天改bug改到后面因为太急了，**直接没测试就传仓库了**...  
所以目前仓库的文件，自己打包压缩以后**是不能直接安装进AstrBot的**...

**这点很抱歉是我的问题**😭

### 那现在怎么办？
- **v1.1.0发行版**：可以正常工作，但是没有网络防护和图像大小限制...  
  所以**最好别用这个**（有安全风险），除非你彻底没招了

- **更早的版本**：可以试试在前几个版本的仓库里，一个一个下载到本地打包安装  
  （我也说不准哪个能用，得自己试试...）

- **期末考试后**：我有时间会继续改bug、更新仓库、恢复插件可用性  
...
### 最近一次AI审核结果在这：
👉 https://github.com/AstrBotDevs/AstrBot/issues/4678  
里面有很多可以改进的方向
