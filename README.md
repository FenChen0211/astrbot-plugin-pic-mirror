...
> ⚠️ **特别说明**：本插件完全由AI编写，连readme.md也是AI写的，作者是高中生（最近期末考没时间测试😭），尚未经过充分测试，特别是**内存泄漏问题**还没测过！欢迎大家帮忙测试和反馈！

> 🆘 **求助**：GIF处理后不会动的问题还没修好，我没招了期待有大佬帮忙修复，欢迎Pull Request!
...
| 指令 | 别名 | 功能描述 |
|------|------|----------|
| `左对称` | `mirror left`, `left`, `左右对称` | 左半边图像对称到右边 |
| `右对称` | `mirror right`, `right`, `右左对称` | 右半边图像对称到左边 |
| `上对称` | `mirror top`, `top`, `上下对称` | 上半边图像对称到下面 |
| `下对称` | `mirror bottom`, `bottom`, `下上对称` | 下半边图像对称到上面 |
| `对称帮助` | `mirror help`, `镜像帮助` | 显示详细使用说明 |
